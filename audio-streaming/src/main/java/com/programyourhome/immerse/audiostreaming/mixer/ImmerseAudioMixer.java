...
import com.programyourhome.immerse.audiostreaming.mixer.loop.AudioLoop;
...
public class ImmerseAudioMixer {
    ...
    private void doUpdate() {
        ...
        AudioLoop audioLoop = new AudioLoop(this.activeScenarios, this.soundCardStreams, this.outputFormat);
    ...
    private void handleScenarioLifecycle(AudioLoop audioLoop) {
