...
import com.programyourhome.immerse.domain.util.TestData;
...
public class Tester {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Scenario scenario2 = scenario(room, fromFilePath(CLAPPING), fixed(0, 0, 0), fixed(5, 5, 5), TestData.settings());

        SoundCard soundCard1 = soundCard(1, "pci-0000:00:14.0-usb-0:1:1.0", speaker1, speaker2);
        SoundCard soundCard2 = soundCard(2, "pci-0000:00:14.0-usb-0:6:1.0", speaker3, speaker4);
